    ...
    return (
        <section className={"relative overflow-hidden bg-gray-50"}>
            <div className={"py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8"}>
                ...
                <div className={"text-center rmb-16"}>
...
function StepItem({icon, label, description}: Step) {
    return <div
        ...
        <div className={"flex flex-col gap-4 h-full"}>
            <div
                className={"flex items-center justify-center h-24 w-24 mx-auto rounded-2xl bg-linear-to-br from-rose-500/10 to-transparent group-hover:from-rose-500/20 transition-colors duration-200"}>
